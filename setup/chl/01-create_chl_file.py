...
if not os.path.isfile('/scratch/servicos/inpe2/nicole.laureanti/data/SeaWifs/seawifs-clim.1997-2010.nc'):
...
wifs = xr.open_dataset("//scratch/servicos/inpe2/nicole.laureanti/data/SeaWifs/seawifs-clim.1997-2010.nc")
...
hgrid = xr.open_dataset("/scratch/servicos/inpe2/nicole.laureanti/BDE28/grid/ocean_hgrid.nc")
...
ds.to_netcdf('//scratch/servicos/inpe2/nicole.laureanti/BDE28/INPUT/chl_mom6.nc', 
    encoding=encodings, 
    format='NETCDF4',
    unlimited_dims='time'
)
