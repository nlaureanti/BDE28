...
def main():
    global date
    date=np.datetime64('2022-01-06')
    glorys_file = f'/scratch/servicos/inpe2//nicole.laureanti/data/glorys/glorys_{date}.nc'
    vgrid_file = '/scratch/servicos/inpe2//nicole.laureanti/BDE28/INPUT/vgrid_75_2m.nc'
#    vgrid_file = 'vgrid_75_5m.nc'
    grid_file = '/scratch/servicos/inpe2//nicole.laureanti/BDE28/grid/ocean_hgrid.nc'
    output_file = f'/scratch/servicos/inpe2//nicole.laureanti/BDE28/INPUT/glorys_ic_75z_{date}.nc'
